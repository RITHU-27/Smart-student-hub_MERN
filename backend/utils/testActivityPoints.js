// Test script for activity points calculator (Backend version)
const { calculateActivityPoints, getCategories, getSubCategories } = require('./activityPointsCalculator');
...
// Run tests
function runTests() {
  console.log('🧪 Running Activity Points Calculator Tests (Backend)...\n');
